...
#coral connectivity matrices

#weighted average connectivity matrix #for context #DELETE LATER
...
#smallest connectivity matrix
load("BaseSimulationWork_1.2022/Conn_Mat_Sum.RData")
smallcoral_PLD_connmat <- Conn_Mat_Sum[[2]]
jointsite_smallcoralPLDconnmat <- smallcoral_PLD_connmat[jointsite_rows, jointsite_rows]

#largest connectivity matrix
#load("BaseSimulationWork_1.2022/Conn_Mat_Sum.RData")
largestcoral_PLD_connmat <- Conn_Mat_Sum[[26]]
jointsite_largestcoralPLDconnmat <- largestcoral_PLD_connmat[jointsite_rows, jointsite_rows]
...
#cycle through the three different scaling factors, tabu and sediment scenarios AND the smallest and largest connectivity matrices
...
connectivs <- c("small", "largest")
#altsed <- "25_alt" #altsed <- c("normalalt", "10_alt")
for(c in 1:length(connectivs)){
    ...
    for(j in 1:length(scalingfactors)){
      ...
      if(c == 1){
        ...
        for(i in 1:length(sitevector)){
          pc_vec[[i]] <- jointsite_smallcoralPLDconnmat[i,] #all inputs to i (coral)
      ...
      if(c == 2){
        pc_vec <- pm_vec <- list()
        for(i in 1:length(sitevector)){
          pc_vec[[i]] <- jointsite_largestcoralPLDconnmat[i,] #all inputs to i (coral)
          pm_vec[[i]] <- jointsite_malg_smallPLDconnmat[i,] #all inputs to i (macroalgae)
        }
      }
      ...
      saveRDS(datalist, file = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/",connectivs[c],"connectivity_Tabu",buffsize[k],"_fullsimrun_allherbs_dval_",altsed[q],"_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_5.2.2024.rds"))
      ...
      BaseRun_newrgamma_allherbivores_InitialCoralCover <-  
        ...
        xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Initial Coral Cover,",connectivs[c],"Connectivity, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
      ...
      ggsave(BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/",connectivs[c],"connectivity_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_InitialCoralCover_ScalingFactor",j,"_5.2.2024.png"), bg = "transparent", height = 10, width = 10) 
      
      #final coral cover
      BaseRun_newrgamma_FinalCoralCover <-  
        ggplot(aes(x = long, y = lat), data = worldmap) + 
        geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
        xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Final Coral Cover,",connectivs[c],"Connectivity, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(BaseRun_newrgamma_FinalCoralCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/",connectivs[c],"connectivity_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_FinalCoralCover_ScalingFactor",j,"_5.2.2024.png"), bg = "transparent", height = 10, width = 10)
      
      #initial malg cover
      BaseRun_newrgamma_InitialMalgCover <-  
        ggplot(aes(x = long, y = lat), data = worldmap) + 
        geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
        xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Initial Malg Cover,",connectivs[c],"Connectivity, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(BaseRun_newrgamma_InitialMalgCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/",connectivs[c],"connectivity_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_InitialMalgCover_ScalingFactor",j,"_5.2.2024.png"), bg = "transparent", height = 10, width = 10)
      
      #final malg cover
      BaseRun_newrgamma_FinalMalgCover <-  
        ggplot(aes(x = long, y = lat), data = worldmap) + 
        geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
        xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Final Malg Cover,",connectivs[c],"Connectivity, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(BaseRun_newrgamma_FinalMalgCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/",connectivs[c],"connectivity_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_FinalMalgCover_ScalingFactor",j,"_5.2.2024.png"), bg = "transparent", height = 10, width = 10)
      ...
      Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover <-  
        ggplot(aes(x = long, y = lat), data = worldmap) + 
        geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
        xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Initial Coral Cover,",connectivs[c],"Connectivity, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/Rounded_",connectivs[c],"connectivity_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_InitialCoralCover_ScalingFactor",j,"_5.2.2024.png"), bg = "transparent", height = 10, width = 10)
      ...
      Rounded_BaseRun_newrgamma_allherbivores_FinalCoralCover <-  
        ggplot(aes(x = long, y = lat), data = worldmap) + 
        geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
        xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Final Coral Cover,",connectivs[c],"Connectivity, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(Rounded_BaseRun_newrgamma_allherbivores_FinalCoralCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/Rounded_",connectivs[c],"connectivity_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_FinalCoralCover_ScalingFactor",j,"_5.2.2024.png"), bg = "transparent", height = 10, width = 10)
      
      #initial malg cover
      Rounded_BaseRun_newrgamma_allherbivores_InitialMalgCover <-  
        ggplot(aes(x = long, y = lat), data = worldmap) + 
        geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
        xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Initial Malg Cover,",connectivs[c],"Connectivity, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(Rounded_BaseRun_newrgamma_allherbivores_InitialMalgCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/Rounded_",connectivs[c],"connectivity_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_InitialMalgCover_ScalingFactor",j,"_5.2.2024.png"), bg = "transparent", height = 10, width = 10)
      
      #final malg cover
      Rounded_BaseRun_newrgamma_allherbivores_FinalMalgCover <-  
        ggplot(aes(x = long, y = lat), data = worldmap) + 
        geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
        xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Final Malg Cover,",connectivs[c],"Connectivity, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
