...
#NEW: Check various large connectivity matrices
load("BaseSimulationWork_1.2022/Conn_Mat_Sum.RData")
largecoral_PLD_connmat <- list()
jointsite_largecoralPLDconnmat <- list()
for(i in 1:23){
  largecoral_PLD_connmat[[i]] <- Conn_Mat_Sum[[(i+2)]]
    ...
    for(k in 1:length(buffsize)){
      for(j in 1:length(scalingfactors)){
        ...
        for(i in 1:length(sitevector)){
          pc_vec[[i]] <- jointsite_largecoralPLDconnmat[[c]][i,] #all inputs to i (coral)
        ...
        saveRDS(datalist, file = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/MoreConnectivityMatrices/",connectivs[c],"PLD_Tabu",buffsize[k],"_fullsimrun_allherbs_dval_",altsed[q],"_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_6.13.2024.rds"))
        ...
        BaseRun_newrgamma_allherbivores_InitialCoralCover <-  
          ...
          xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Initial Coral Cover,",connectivs[c],"PLD, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
        ...
        ggsave(BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/MoreConnectivityMatrices/",connectivs[c],"PLD_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_InitialCoralCover_ScalingFactor",j,"_6.13.2024.png"), bg = "transparent", height = 10, width = 10) 
        
        #final coral cover
        BaseRun_newrgamma_FinalCoralCover <-  
          ggplot(aes(x = long, y = lat), data = worldmap) + 
          geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
          xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Final Coral Cover,",connectivs[c],"PLD, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
          ...
          scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                             ...
                             labels = c(160, 170, "180/-180", -170)) +
          coord_equal() +  theme_bw()
        ggsave(BaseRun_newrgamma_FinalCoralCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/MoreConnectivityMatrices/",connectivs[c],"PLD_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_FinalCoralCover_ScalingFactor",j,"_6.13.2024.png"), bg = "transparent", height = 10, width = 10)
        
        #initial malg cover
        BaseRun_newrgamma_InitialMalgCover <-  
          ggplot(aes(x = long, y = lat), data = worldmap) + 
          geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
          xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Initial Malg Cover,",connectivs[c],"PLD, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
          ...
          scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                             ...
                             labels = c(160, 170, "180/-180", -170)) +
          coord_equal() +  theme_bw()
        ggsave(BaseRun_newrgamma_InitialMalgCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/MoreConnectivityMatrices/",connectivs[c],"PLD_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_InitialMalgCover_ScalingFactor",j,"_6.13.2024.png"), bg = "transparent", height = 10, width = 10)
        
        #final malg cover
        BaseRun_newrgamma_FinalMalgCover <-  
          ggplot(aes(x = long, y = lat), data = worldmap) + 
          geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
          xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Final Malg Cover,",connectivs[c],"PLD, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
          ...
          scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                             ...
                             labels = c(160, 170, "180/-180", -170)) +
          coord_equal() +  theme_bw()
        ggsave(BaseRun_newrgamma_FinalMalgCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/MoreConnectivityMatrices/",connectivs[c],"PLD_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_FinalMalgCover_ScalingFactor",j,"_6.13.2024.png"), bg = "transparent", height = 10, width = 10)
        ...
        Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover <-  
          ggplot(aes(x = long, y = lat), data = worldmap) + 
          geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
          xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Initial Coral Cover,",connectivs[c],"PLD, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
          ...
          scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                             ...
                             labels = c(160, 170, "180/-180", -170)) +
          coord_equal() +  theme_bw()
        ggsave(Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("Final_Simulations/AddingConnectivitySensitivityAnalyses/MoreConnectivityMatrices/Rounded_",connectivs[c],"PLD_Tabu",buffsize[k],"_dval_",altsed[q],"_r",r,"gamma",gamma,"_allherbivores_InitialCoralCover_ScalingFactor",j,"_6.13.2024.png"), bg = "transparent", height = 10, width = 10)
        ...
        Rounded_BaseRun_newrgamma_allherbivores_FinalCoralCover <-  
          ggplot(aes(x = long, y = lat), data = worldmap) + 
          geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
          xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Final Coral Cover,",connectivs[c],"PLD, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
        ...
        Rounded_BaseRun_newrgamma_allherbivores_FinalMalgCover <-  
          ggplot(aes(x = long, y = lat), data = worldmap) + 
          geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
          xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Final Malg Cover,",connectivs[c],"PLD, Scaling Factor ", j,"d = ", altsed[q], "buffer size = ", buffsize[k]))+
