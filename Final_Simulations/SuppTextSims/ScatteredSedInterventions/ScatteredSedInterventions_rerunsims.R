...
testing <- load("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/benthicfish_masterdataset_sed_tabubuffer0.02_qoliqolionly_5.6.2023.RData")
...
for(l in 1:4){ 
  for(j in 1:length(scalingfactors)){
    ...
    saveRDS(datalist, file = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/ScatteredSedInterventions/ScatteredSedimentScenario_fullsimrun_allherbs_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_sedfactor",sedfactor_names[l],"_5.6.2023.rds"))
    ...
    ggsave(BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/ScatteredSedInterventions/Run_r",r,"gamma",gamma,"_sedfactor",sedfactor_names[l],"_allherbivores_InitialCoralCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    ...
    BaseRun_newrgamma_FinalCoralCover <-  
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(BaseRun_newrgamma_FinalCoralCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/ScatteredSedInterventions/Run_r",r,"gamma",gamma,"_sedfactor",sedfactor_names[l],"_allherbivores_FinalCoralCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    ...
    BaseRun_newrgamma_InitialMalgCover <-  
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(BaseRun_newrgamma_InitialMalgCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/ScatteredSedInterventions/Run_r",r,"gamma",gamma,"_sedfactor",sedfactor_names[l],"_allherbivores_InitialMalgCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    ...
    Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover <-  
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/ScatteredSedInterventions/Rounded_Run_r",r,"gamma",gamma,"_sedfactor",sedfactor_names[l],"_allherbivores_InitialCoralCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    ...
    ScatteredSedLevels_Map <-  
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(ScatteredSedLevels_Map, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/ScatteredSedInterventions/ScatteredSedLevels_Map_r",r,"gamma",gamma,"_sedfactor",sedfactor_names[l],"_allherbivores_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
