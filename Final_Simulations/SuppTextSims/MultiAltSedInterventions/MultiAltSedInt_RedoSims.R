...
hist(benthicfish_masterdataset_sed$sediment_altalt)
#####

#cycle through the three different scaling factors and the 5 different sedimentation levels
for(l in 1:9){ 
  for(j in 1:length(scalingfactors)){
    ...
    d_val <- benthicfish_masterdataset$sediment_altalt*(1-(0.1*(l))) #if l = 1 -> mult by 0.9
    r <- 6500 #NEW VALUE #rate coral recruits onto/overgrows turf algae
    gamma <- 1900 #NEW VALUE #rate macroalgae recruits onto/overgrows turf algae
    ...
    parameters <- list(a <- 0.1, d <- d_val, g <- g_val, r <- 6500, gamma <- 1900, p_c <- pc_vec, p_m <- pm_vec, le <- length(sitevector))
    ...
    saveRDS(datalist, file = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/MultiAltSedInterventions/SedimentScenario_fullsimrun_allherbs_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_sedfactor",l,"_5.6.2023.rds"))
    ...
    BaseRun_newrgamma_allherbivores_InitialCoralCover <-  
      ...
      xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Initial Coral Cover, Scaling Factor ", j," Base Run r =",r," gamma =", gamma,"sedfactor", l))+
    ...
    ggsave(BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/MultiAltSedInterventions/Run_r",r,"gamma",gamma,"_sedfactor",l,"_allherbivores_InitialCoralCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    
    #final coral cover
    BaseRun_newrgamma_FinalCoralCover <-  
      ggplot(aes(x = long, y = lat), data = worldmap) + 
      geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
      xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Final Coral Cover, Scaling Factor ", j," Base Run r =",r," gamma =", gamma,"sedfactor", l))+
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(BaseRun_newrgamma_FinalCoralCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/MultiAltSedInterventions/Run_r",r,"gamma",gamma,"_sedfactor",l,"_allherbivores_FinalCoralCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    
    #initial malg cover
    BaseRun_newrgamma_InitialMalgCover <-  
      ggplot(aes(x = long, y = lat), data = worldmap) + 
      geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
      xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Initial Malg Cover, Scaling Factor ", j," Base Run r =",r," gamma =", gamma,"sedfactor", l))+
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(BaseRun_newrgamma_InitialMalgCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/MultiAltSedInterventions/Run_r",r,"gamma",gamma,"_sedfactor",l,"_allherbivores_InitialMalgCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    
    #final malg cover
    BaseRun_newrgamma_FinalMalgCover <-  
      ggplot(aes(x = long, y = lat), data = worldmap) + 
      geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
      xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Final Malg Cover, Scaling Factor ", j," Base Run r =",r," gamma =", gamma,"sedfactor", l))+
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(BaseRun_newrgamma_FinalMalgCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/MultiAltSedInterventions/Run_r",r,"gamma",gamma,"_sedfactor",l,"_allherbivores_FinalMalgCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    ...
    Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover <-  
      ggplot(aes(x = long, y = lat), data = worldmap) + 
      geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
      xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Initial Coral Cover, Gamma ", gamma,"r",r,"Scaling Factor",j,"sedfactor",l))+
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/MultiAltSedInterventions/Rounded_Run_r",r,"gamma",gamma,"_sedfactor",l,"_allherbivores_InitialCoralCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
    
    #final coral cover
    Rounded_BaseRun_newrgamma_allherbivores_FinalCoralCover <-  
      ggplot(aes(x = long, y = lat), data = worldmap) + 
      geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
      xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Final Coral Cover, Gamma ", gamma,"r",r,"Scaling Factor",j,"sedfactor", l))+
    ...
    Rounded_BaseRun_newrgamma_allherbivores_InitialMalgCover <-  
      ggplot(aes(x = long, y = lat), data = worldmap) + 
      geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
      xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Initial Malg Cover, Gamma ", gamma,"r",r,"Scaling Factor",j,"sedfactor", l))+
    ...
    Rounded_BaseRun_newrgamma_allherbivores_FinalMalgCover <-  
      ggplot(aes(x = long, y = lat), data = worldmap) + 
      geom_polygon(aes(group = group), fill="#f9f9f9", colour = "grey65") +
      xlab("Longitude") + ylab("Latitude")+ ggtitle(paste("Rounded Final Malg Cover, Gamma ", gamma,"r",r,"Scaling Factor",j,"sedfactor", l))+
      ...
      scale_x_continuous(limits = c(180 - 2, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180) #c(180 - 3, 180 + 1)
                         ...
                         labels = c(160, 170, "180/-180", -170)) +
      coord_equal() +  theme_bw()
    ggsave(Rounded_BaseRun_newrgamma_allherbivores_FinalMalgCover, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/SuppTextSims/MultiAltSedInterventions/Rounded_Run_r",r,"gamma",gamma,"_sedfactor",l,"_allherbivores_FinalMalgCover_ScalingFactor",j,"_5.6.2023.png"), bg = "transparent", height = 10, width = 10)
