...
varying_initcond <- data.frame(a = 0.1, d = 0.24, g = rep(scalingfactors,length(initconds)), C_init = rep(initconds, each = length(scalingfactors)), M_init = rep(c(0.8,0.1,0.8,0.1), each = length(scalingfactors)), vary = rep(c("n","y"),each = length(scalingfactors)*length(initconds)))
...
for(q in 1:length(altsed)){ #sedimentation scenarios
  for(k in 1:length(buffsize)){ #tabu scenarios
    for(j in 37:48){ #1:dim(paramsies)[1] #sensitivity analysis, grazing level and initial condition scenarios
      if(j < 25){inity <- "default"}
      if(j > 24 & j < 37){inity <- paramsies$C_init[j]}
      if(j > 36){inity <- paste0("vary",paramsies$C_init[j])}
      ...
      ggsave(BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("Final_Simulations/AddingMoreSensitivityAnalyses_MoreInitConds/ExtraGraphs/SI_Tabu",buffsize[k],"_dval_",altsed[q],"_a",paramsies$a[j],"d",paramsies$d[j],"_scalingfactor",j,"_",inity,"Cinit_allherbivores_InitialCoralCover_ScalingFactor",j,"_4.9.2025.png"), bg = "transparent", height = 10, width = 10) 
      ...
      BaseRun_newrgamma_FinalCoralCover <-  
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(BaseRun_newrgamma_FinalCoralCover, filename = paste0("Final_Simulations/AddingMoreSensitivityAnalyses_MoreInitConds/ExtraGraphs/SI_Tabu",buffsize[k],"_dval_",altsed[q],"_a",paramsies$a[j],"d",paramsies$d[j],"_scalingfactor",j,"_",inity,"Cinit_FinalCoralCover_ScalingFactor",j,"_4.9.2025.png"), bg = "transparent", height = 10, width = 10)
      ...
      BaseRun_newrgamma_InitialMalgCover <-  
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(BaseRun_newrgamma_InitialMalgCover, filename = paste0("Final_Simulations/AddingMoreSensitivityAnalyses_MoreInitConds/ExtraGraphs/SI_Tabu",buffsize[k],"_dval_",altsed[q],"_a",paramsies$a[j],"d",paramsies$d[j],"_scalingfactor",j,"_",inity,"Cinit_InitialMalgCover_ScalingFactor",j,"_4.9.2025.png"), bg = "transparent", height = 10, width = 10)
      ...
      BaseRun_newrgamma_FinalMalgCover <-  
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(BaseRun_newrgamma_FinalMalgCover, filename = paste0("Final_Simulations/AddingMoreSensitivityAnalyses_MoreInitConds/ExtraGraphs/SI_Tabu",buffsize[k],"_dval_",altsed[q],"_a",paramsies$a[j],"d",paramsies$d[j],"_scalingfactor",j,"_",inity,"Cinit_allherbivores_FinalMalgCover_ScalingFactor",j,"_4.9.2025.png"), bg = "transparent", height = 10, width = 10)
      ...
      Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover <-  
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(Rounded_BaseRun_newrgamma_allherbivores_InitialCoralCover, filename = paste0("Final_Simulations/AddingMoreSensitivityAnalyses_MoreInitConds/ExtraGraphs/Rounded_SI_Tabu",buffsize[k],"_dval_",altsed[q],"_a",paramsies$a[j],"d",paramsies$d[j],"_scalingfactor",j,"_",inity,"Cinit_allherbivores_InitialCoralCover_ScalingFactor",j,"_4.9.2025.png"), bg = "transparent", height = 10, width = 10)
      ...
      Rounded_BaseRun_newrgamma_allherbivores_FinalCoralCover <-  
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(Rounded_BaseRun_newrgamma_allherbivores_FinalCoralCover, filename = paste0("Final_Simulations/AddingMoreSensitivityAnalyses_MoreInitConds/ExtraGraphs/Rounded_SI_Tabu",buffsize[k],"_dval_",altsed[q],"_a",paramsies$a[j],"d",paramsies$d[j],"_scalingfactor",j,"_",inity,"Cinit_allherbivores_FinalCoralCover_ScalingFactor",j,"_4.9.2025.png"), bg = "transparent", height = 10, width = 10)
      ...
      Rounded_BaseRun_newrgamma_allherbivores_InitialMalgCover <-  
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(Rounded_BaseRun_newrgamma_allherbivores_InitialMalgCover, filename = paste0("Final_Simulations/AddingMoreSensitivityAnalyses_MoreInitConds/ExtraGraphs/Rounded_SI_Tabu",buffsize[k],"_dval_",altsed[q],"_a",paramsies$a[j],"d",paramsies$d[j],"_scalingfactor",j,"_",inity,"Cinit_allherbivores_InitialMalgCover_ScalingFactor",j,"_4.9.2025.png"), bg = "transparent", height = 10, width = 10)
      ...
      Rounded_BaseRun_newrgamma_allherbivores_FinalMalgCover <-  
        ...
        scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                           ...
                           labels = c(160, 170, "180/-180", -170)) +
        coord_equal() +  theme_bw()
      ggsave(Rounded_BaseRun_newrgamma_allherbivores_FinalMalgCover, filename = paste0("Final_Simulations/AddingMoreSensitivityAnalyses_MoreInitConds/ExtraGraphs/Rounded_SI_Tabu",buffsize[k],"_dval_",altsed[q],"_a",paramsies$a[j],"d",paramsies$d[j],"_scalingfactor",j,"_",inity,"Cinit_allherbivores_FinalMalgCover_ScalingFactor",j,"_4.9.2025.png"), bg = "transparent", height = 10, width = 10)
