...
scens <- c("base_dvar", "25altsed", "tabu_qoliqoli_dvar", "tabuqoliqoli_25sed_dvar")
...
for(j in 1:3){ 
  for(k in 1:length(scens)){
    ...
    if(k == 1){
      ...
      data <- readRDS(file = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/MainTextSims/MainText_Tabuoriginal_fullsimrun_allherbs_dval_baseline_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_5.6.2023.rds"))
    }
    
    #10altsed #9.12.2023: switching to 25% bc it shows the pattern clearer
    #if(k == 2){
    #  data <- readRDS(file = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/MainTextSims/MainText_Tabuoriginal_fullsimrun_allherbs_dval_10_alt_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_5.6.2023.rds"))
    #}
    
    #25altsed
    if(k == 2){
      data <- readRDS(file = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/MainTextSims/MainText_Tabuoriginal_fullsimrun_allherbs_dval_25_alt_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_5.6.2023.rds"))
    }
    
    #tabu_qoliqoli_dvar
    if(k == 3){
      data <- readRDS(file = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/MainTextSims/MainText_Tabuqoliqoli_fullsimrun_allherbs_dval_baseline_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_5.6.2023.rds"))
    }
    
    #10% + qoli qoli
    #if(k == 4){
    #  data <- readRDS(file = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/MainTextSims/MainText_Tabuqoliqoli_fullsimrun_allherbs_dval_10_alt_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_5.6.2023.rds"))
    #}
    
    #25% + qoli qoli
    if(k == 4){
      data <- readRDS(file = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/MainTextSims/MainText_Tabuqoliqoli_fullsimrun_allherbs_dval_25_alt_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_5.6.2023.rds"))
    }
...
coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm <- ggplot(finalcov_restr, aes(x=scenario, y=coral_cover*100,colour=scenario, alpha = 0.9)) + 
  ...
  scale_x_discrete(limits=c("base_dvar", "tabu_qoliqoli_dvar", "25altsed", "tabuqoliqoli_25sed_dvar"), labels=c("baseline", "tabu", "water qual", "both"), name = "Management Strategy")+
  scale_colour_manual(values=c("black","#FFC000", "#56B4E9","#AB56FC"),breaks=c("base_dvar", "tabu_qoliqoli_dvar", "25altsed", "tabuqoliqoli_25sed_dvar"), labels=c("Baseline", "Expand tabu area", "Improve Water Quality", "Combination of the Two"), name = "Management Strategy")+ 
...
#facet_wrap(~graz)
ggsave(coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm, filename = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/PosterFigures_9.2023/coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_poster_25pct_9.12.2023.png"), bg = "transparent", height = 10, width = 10)
...
load("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/benthicfish_masterdataset_sed_tabubuffer0.02_qoliqolionly_5.6.2023.RData")
...
load("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/benthicfish_masterdataset_sed_tabubuffer0.05_5.6.2023.RData")
#which reefs are 'newly in tabus'?
...
scenz <- c("qoliqoli_basedvar", "altsed25_basedvar", "altsed25_qoliqoli_basedvar")
...
for(i in 1:3){
  ...
  finalcov_changes$coral_cover[finalcov_changes$graz == i & finalcov_changes$scenario == scenz[2]] <- finalcov_restr$coral_cover[finalcov_restr$graz == i & finalcov_restr$scenario == "25altsed"] - finalcov_restr$coral_cover[finalcov_restr$graz == i & finalcov_restr$scenario == "base_dvar"]
  finalcov_changes$malg_cover[finalcov_changes$graz == i & finalcov_changes$scenario == scenz[2]] <- finalcov_restr$malg_cover[finalcov_restr$graz == i & finalcov_restr$scenario == "25altsed"] - finalcov_restr$malg_cover[finalcov_restr$graz == i & finalcov_restr$scenario == "base_dvar"]
  finalcov_changes$ratio[finalcov_changes$graz == i & finalcov_changes$scenario == scenz[2]] <- finalcov_restr$ratio[finalcov_restr$graz == i & finalcov_restr$scenario == "25altsed"] - finalcov_restr$ratio[finalcov_restr$graz == i & finalcov_restr$scenario == "base_dvar"]
  ...
  finalcov_changes$coral_cover[finalcov_changes$graz == i & finalcov_changes$scenario == scenz[3]] <- finalcov_restr$coral_cover[finalcov_restr$graz == i & finalcov_restr$scenario == "tabuqoliqoli_25sed_dvar"] - finalcov_restr$coral_cover[finalcov_restr$graz == i & finalcov_restr$scenario == "base_dvar"]
  finalcov_changes$malg_cover[finalcov_changes$graz == i & finalcov_changes$scenario == scenz[3]] <- finalcov_restr$malg_cover[finalcov_restr$graz == i & finalcov_restr$scenario == "tabuqoliqoli_25sed_dvar"] - finalcov_restr$malg_cover[finalcov_restr$graz == i & finalcov_restr$scenario == "base_dvar"]
  finalcov_changes$ratio[finalcov_changes$graz == i & finalcov_changes$scenario == scenz[3]] <- finalcov_restr$ratio[finalcov_restr$graz == i & finalcov_restr$scenario == "tabuqoliqoli_25sed_dvar"] - finalcov_restr$ratio[finalcov_restr$graz == i & finalcov_restr$scenario == "base_dvar"]
...
changeincoralcover_w25_abr <- ggplot(finalcov_changes, aes(x = scenario, y = coral_cover*100, alpha = 0.9)) +
  ...
  scale_x_discrete(limits=c("qoliqoli_basedvar", "altsed25_basedvar","altsed25_qoliqoli_basedvar"), labels=c("tabu", "water qual", "both"), name = "Management Strategy")+
  scale_color_manual(values=c("#FFC000", "#56B4E9","#AB56FC"),breaks=c("qoliqoli_basedvar", "altsed25_basedvar", "altsed25_qoliqoli_basedvar"), labels=c("Expand tabu area", "Improve Water Quality", "Combination of the Two"), name = "Management Strategy")+
  ...
  #facet_wrap(~graz)
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeincoralcover_w25_abr, filename = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/PosterFigures_9.2023/changeincoralcover_w25_abr_mgmtstressorimpactassessment_summary_poster_25pct_9.12.2023.png"), bg = "transparent", height = 10, width = 7)
...
changeinmalgcover_w25_abr <- ggplot(finalcov_changes, aes(x = scenario, y = malg_cover*100, alpha = 0.9)) +
  ...
  #facet_wrap(~graz)
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinmalgcover_w25_abr, filename = paste0("~/Dropbox/GitHub/PhDProjects/Fiji_StabilityConnectivitySimulation/Final_Simulations/PosterFigures_9.2023/changeinmalgcover_w25_abr_mgmtstressorimpactassessment_summary_poster_25pct_9.12.2023.png"), bg = "transparent", height = 10, width = 7)
