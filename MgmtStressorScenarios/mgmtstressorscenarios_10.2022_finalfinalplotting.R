...
#facet_wrap(~graz)
ggsave(coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_10.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm <- ggplot(finalcov_restr, aes(x=scenario, y=malg_cover*100,colour=scenario, alpha = 0.9)) + 
  ...
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
#facet_wrap(~graz)
ggsave(malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_10.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
changeincoralcover_w25_abr <- ggplot(finalcov_changes, aes(x = scenario, y = coral_cover*100, alpha = 0.9)) +
  ...
  #facet_wrap(~graz)
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeincoralcover_w25_abr, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeincoralcover_w25_abr_mgmtstressorimpactassessment_summary_10.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeinmalgcover_w25_abr <- ggplot(finalcov_changes, aes(x = scenario, y = malg_cover*100, alpha = 0.9)) +
  ...
  #facet_wrap(~graz)
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinmalgcover_w25_abr, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeinmalgcover_w25_abr_mgmtstressorimpactassessment_summary_10.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeinCMratio_w25_abr <- ggplot(finalcov_changes, aes(x = scenario, y = ratio, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "red")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinCMratio_w25_abr, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeinCMratio_w25_abr_mgmtstressorimpactassessment_summary_10.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeincoralcover_w25_abr_qoliqolicoloured <- ggplot(finalcov_changes_qq, aes(x = scenario, y = coral_cover*100, color = identity_qoliqoli, alpha = 0.9)) +
  ...
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeincoralcover_w25_abr_qoliqolicoloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeincoralcover_w25_abr_qoliqolicoloured_10.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeinmalgcover_w25_abr_qoliqolicoloured <- ggplot(finalcov_changes_qq, aes(x = scenario, y = malg_cover*100, color = identity_qoliqoli, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "black")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinmalgcover_w25_abr_qoliqolicoloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeinmalgcover_w25_abr_qoliqolicoloured_10.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeinCMratio_w25_abr_qoliqolicoloured <- ggplot(finalcov_changes_qq, aes(x = scenario, y = ratio, color = identity_qoliqoli, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "black")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinCMratio_w25_abr_qoliqolicoloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeinCMratio_w25_abr_qoliqolicoloured_10.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeincoralcover_w25_abr_tabu5coloured <- ggplot(finalcov_changes_0.05, aes(x = scenario, y = coral_cover*100, color = identity_0.05, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "black")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeincoralcover_w25_abr_tabu5coloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeincoralcover_w25_abr_tabu5coloured_10.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
changeinmalgcover_w25_abr_tabu5coloured <- ggplot(finalcov_changes_0.05, aes(x = scenario, y = malg_cover*100, color = identity_0.05, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "black")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinmalgcover_w25_abr_tabu5coloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeinmalgcover_w25_abr_tabu5coloured_10.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
changeinCMratio_w25_abr_tabu5coloured <- ggplot(finalcov_changes_0.05, aes(x = scenario, y = ratio, color = identity_0.05, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "black")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinCMratio_w25_abr_tabu5coloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/changeinCMratio_w25_abr_tabu5coloured_10.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus <- ggplot(finalcov_restr_qqtabu, aes(x=scenario, y=coral_cover*100,colour=identity_qoliqoli, alpha = 0.9)) + 
  ...
  #geom_jitter(shape=16, size = 0.2, position=position_jitter(0.2))+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus_10.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus <- ggplot(finalcov_restr_qqtabu, aes(x=scenario, y=malg_cover*100,colour=identity_qoliqoli, alpha = 0.9)) + 
  ...
  #geom_jitter(shape=16, size = 0.2, position=position_jitter(0.2))+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus_10.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus <- ggplot(finalcov_restr_5tabu, aes(x=scenario, y=coral_cover*100,colour=identity_0.05, alpha = 0.9)) + 
  ...
  #geom_jitter(shape=16, size = 0.2, position=position_jitter(0.2))+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus_10.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus <- ggplot(finalcov_restr_5tabu, aes(x=scenario, y=malg_cover*100,colour=identity_0.05, alpha = 0.9)) + 
  ...
  #geom_jitter(shape=16, size = 0.2, position=position_jitter(0.2))+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/malgcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus_10.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
coralcover_grazinglevel_dvaronlyabr_w25_grazcol <- ggplot(finalcov_restr, aes(x = grazinglevel, y = coral_cover*100, color = as.factor(graz))) +
  ...
  scale_color_manual(values=c("#fc8d59","#ffffbf","#91cf60"),breaks=c(2,3,4), labels=c("Low", "Medium","High"), name = "Grazing Scenario")+
  theme(axis.text.x = element_text(size = 20), axis.text.y = element_text(size=20)) #"#d7191c","#fdae61","#abdda4"
#facet_wrap(~graz)
ggsave(coralcover_grazinglevel_dvaronlyabr_w25_grazcol, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/coralcover_grazinglevel_dvaronlyabr_w25_grazcol_11.8.2022.png"), bg = "transparent", height = 10, width = 10)
...
#facet_wrap(~graz)
ggsave(malgcover_grazinglevel_dvaronlyabr_w25_grazcol, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/malgcover_grazinglevel_dvaronlyabr_w25_grazcol_11.8.2022.png"), bg = "transparent", height = 10, width = 10)
...
coralcover_grazinglevel_dvaronlyabr_w25_grazcol_sepbygraz <- ggplot(finalcov_restr, aes(x = grazinglevel, y = coral_cover*100, color = as.factor(graz))) +
  ...
  theme(axis.text.x = element_text(size = 20), axis.text.y = element_text(size=20))+
  facet_wrap(~graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(coralcover_grazinglevel_dvaronlyabr_w25_grazcol_sepbygraz, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/coralcover_grazinglevel_dvaronlyabr_w25_grazcol_sepbygraz_11.8.2022.png"), bg = "transparent", height = 10, width = 10)
...
coralcover_mortalitylevel_dvaronlyabr_w25_grazcol <- ggplot(finalcov_restr, aes(x = mortalitylevel, y = coral_cover*100, color = as.factor(graz))) +
  ...
  theme(axis.text.x = element_text(size = 20), axis.text.y = element_text(size=20))
#facet_wrap(~graz)
ggsave(coralcover_mortalitylevel_dvaronlyabr_w25_grazcol, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/10.2022_finalplots/coralcover_mortalitylevel_dvaronlyabr_w25_grazcol_11.9.2022.png"), bg = "transparent", height = 10, width = 10)
...
#NEED TO REMOVE EMPIRICAL SCENARIO FROM THIS CODE
#final coral cover
...
for(i in 1:4){ 
  RoundedFinalCoralCov_basedvar_consistentcolours <-  
    ...
    scale_x_continuous(limits = c(180 - 3, 180 + 1), #c(180 - 3, 180 + 1) #c(180 - 3, 180 + 2.5) #c(180 - 3, 180)
                       ...
                       labels = c(160, 170, "180/-180", -170)) +
    coord_equal() +  theme_bw()
  ggsave(RoundedFinalCoralCov_basedvar_consistentcolours, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/ExtraThings_4.2022/RoundedFinalCoralCov_basedvar_consistentcolours_graz",i,"_11.27.2022_blk.png"), bg = "transparent", height = 10, width = 10)
...
#scens <- c("base_dvar", "10altsed", "25altsed", "tabu_qoliqoli_dvar", "tabu_0.05_dvar", "tabuqoliqoli_10sed_dvar", "tabuqoliqoli_25sed_dvar")
#base_dvar: low = 43, medium = 28, high = 28
length(finalcov_restr_lessone$coral_cover[finalcov_restr_lessone$scenario == "base_dvar" & finalcov_restr_lessone$graz == 4])
...
#base_dvar: low = 66, medium = 28, high = 28
length(finalcov_restr_lessten$coral_cover[finalcov_restr_lessten$scenario == "base_dvar" & finalcov_restr_lessten$graz == 4])
