...
coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm <- ggplot(finalcov_restr, aes(x=scenario, y=coral_cover*100,colour=scenario, alpha = 0.9)) + 
  ...
  scale_colour_manual(values=c("black","#FFC000", "#E69F00","#94cceb", "#56B4E9","#c790fc", "#AB56FC"),breaks=c("base_dvar", "tabu_qoliqoli_dvar", "tabu_0.05_dvar", "10altsed", "25altsed", "tabuqoliqoli_10sed_dvar", "tabuqoliqoli_25sed_dvar"), labels=c("base", "1", "2", "3", "4", "5", "6"), name = "Management Intervention")+ 
  ...
  #facet_wrap(~graz)
ggsave(coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_9.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
changeincoralcover_w25_abr <- ggplot(finalcov_changes, aes(x = scenario, y = coral_cover*100, alpha = 0.9)) +
  ...
  scale_color_manual(values=c("#FFC000", "#E69F00","#94cceb", "#56B4E9","#c790fc", "#AB56FC"),breaks=c("qoliqoli_basedvar", "tabu0.05_basedvar", "altsed10_basedvar", "altsed25_basedvar", "altsed10_qoliqoli_basedvar", "altsed25_qoliqoli_basedvar"), labels=c("1", "2", "3", "4","5", "6"), name = "Management Intervention")+
  ...
  #facet_wrap(~graz)
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeincoralcover_w25_abr, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/changeincoralcover_w25_abr_mgmtstressorimpactassessment_summary_9.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeinCMratio_w25_abr <- ggplot(finalcov_changes, aes(x = scenario, y = ratio, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "red")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinCMratio_w25_abr, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/changeinCMratio_w25_abr_mgmtstressorimpactassessment_summary_9.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeincoralcover_w25_abr_qoliqolicoloured <- ggplot(finalcov_changes_qq, aes(x = scenario, y = coral_cover*100, color = identity_qoliqoli, alpha = 0.9)) +
  ...
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeincoralcover_w25_abr_qoliqolicoloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/changeincoralcover_w25_abr_qoliqolicoloured_9.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeinCMratio_w25_abr_qoliqolicoloured <- ggplot(finalcov_changes_qq, aes(x = scenario, y = ratio, color = identity_qoliqoli, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "black")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinCMratio_w25_abr_qoliqolicoloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/changeinCMratio_w25_abr_qoliqolicoloured_9.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
changeincoralcover_w25_abr_tabu5coloured <- ggplot(finalcov_changes_0.05, aes(x = scenario, y = coral_cover*100, color = identity_0.05, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "black")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeincoralcover_w25_abr_tabu5coloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/changeincoralcover_w25_abr_tabu5coloured_9.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
changeinCMratio_w25_abr_tabu5coloured <- ggplot(finalcov_changes_0.05, aes(x = scenario, y = ratio, color = identity_0.05, alpha = 0.9)) +
  ...
  geom_hline(yintercept = 0, color = "black")+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(changeinCMratio_w25_abr_tabu5coloured, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/changeinCMratio_w25_abr_tabu5coloured_9.27.2022.png"), bg = "transparent", height = 10, width = 5)
...
finalcov_restr$identity_qoliqoli <- rep(tabus_qoliqoli,4)
finalcov_restr$identity_0.05 <- rep(tabus_0.05,4)
...
coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus <- ggplot(finalcov_restr_qqtabu, aes(x=scenario, y=coral_cover*100,colour=identity_qoliqoli, alpha = 0.9)) + 
  ...
  #geom_jitter(shape=16, size = 0.2, position=position_jitter(0.2))+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_qqtabus_9.27.2022.png"), bg = "transparent", height = 10, width = 10)

#line plot??
finalcov_restr_qqtabu_line <- finalcov_restr_qqtabu
finalcov_restr_qqtabu_line$scen_num <- rep(seq(1,4,1), each = numreefs) #only 4 scenarios included here
coralcover_line_mgmtstressorimpactassessment_qqtabu <- ggplot(finalcov_restr_qqtabu_line, aes(x=scen_num, y=coral_cover*100, group = reef, colour = identity_qoliqoli)) + 
  geom_line()+
  geom_point()+
  ggtitle("Coral Cover, dvar only, qqtabu lines")+
  scale_x_discrete(limits=c("base_dvar", "tabu_qoliqoli_dvar", "tabuqoliqoli_10sed_dvar", "tabuqoliqoli_25sed_dvar"), labels=c("base", "qoliqoli tabu", "qoliqoli_10sed", "qoliqoli_25sed"))+
  geom_hline(yintercept = 30, color = "black")+
  facet_wrap(~graz)
ggsave(coralcover_line_mgmtstressorimpactassessment_qqtabu, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/coralcover_line_mgmtstressorimpactassessment_qqtabu_8.26.2022.png"), bg = "transparent", height = 10, width = 10)
...
coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus <- ggplot(finalcov_restr_5tabu, aes(x=scenario, y=coral_cover*100,colour=identity_0.05, alpha = 0.9)) + 
  ...
  #geom_jitter(shape=16, size = 0.2, position=position_jitter(0.2))+
  facet_wrap(~ graz, labeller = labeller(graz = grazinglevels.labs))
ggsave(coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/coralcover_mgmtstressorimpactassessmentabrw25_summary_beeswarm_5tabus_9.27.2022.png"), bg = "transparent", height = 10, width = 10)

#line plot??
finalcov_restr_5tabu_line <- finalcov_restr_5tabu
finalcov_restr_5tabu_line$scen_num <- rep(seq(1,2,1), each = numreefs) #only 2 scenarios included here
coralcover_line_mgmtstressorimpactassessment_5tabu <- ggplot(finalcov_restr_5tabu_line, aes(x=scen_num, y=coral_cover*100, group = reef, colour = identity_0.05)) + 
  geom_line()+
  geom_point()+
  ggtitle("Coral Cover, dvar only, 5km tabu lines")+
  scale_x_discrete(limits=c("base_dvar", "tabu_0.05_dvar"), labels=c("base", "5km tabu"))+
  geom_hline(yintercept = 30, color = "black")+
  facet_wrap(~graz)
ggsave(coralcover_line_mgmtstressorimpactassessment_5tabu, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/coralcover_line_mgmtstressorimpactassessment_5tabu_8.26.2022.png"), bg = "transparent", height = 10, width = 10)
...
load("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/benthicfish_masterdataset_sed_tabubuffer0.02_qoliqolionly_6.30.2022.RData") #benthicfish_masterdataset_sed
...
load("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/benthicfish_masterdataset_sed_tabubuffer0.05_5.26.2022.RData") #benthicfish_masterdataset_sed
...
finalcov_restr$grazinglevel[finalcov_restr$graz == 2 & finalcov_restr$scenario %in% c("tabu_qoliqoli_dvar","tabuqoliqoli_10sed_dvar", "tabuqoliqoli_25sed_dvar")] <- benthicfish_masterdataset_sed_qoliqoli$new_grazinglevel*MD_scale
finalcov_restr$grazinglevel[finalcov_restr$graz == 3 & finalcov_restr$scenario %in% c("tabu_qoliqoli_dvar","tabuqoliqoli_10sed_dvar", "tabuqoliqoli_25sed_dvar")] <- benthicfish_masterdataset_sed_qoliqoli$new_grazinglevel*ASS_scale
finalcov_restr$grazinglevel[finalcov_restr$graz == 4 & finalcov_restr$scenario %in% c("tabu_qoliqoli_dvar","tabuqoliqoli_10sed_dvar", "tabuqoliqoli_25sed_dvar")] <- benthicfish_masterdataset_sed_qoliqoli$new_grazinglevel*CD_scale
...
finalcov_restr$grazinglevel[finalcov_restr$graz == 2 & finalcov_restr$scenario == "tabu_0.05_dvar"] <- benthicfish_masterdataset_sed_5km$new_grazinglevel*MD_scale
finalcov_restr$grazinglevel[finalcov_restr$graz == 3 & finalcov_restr$scenario == "tabu_0.05_dvar"] <- benthicfish_masterdataset_sed_5km$new_grazinglevel*ASS_scale
finalcov_restr$grazinglevel[finalcov_restr$graz == 4 & finalcov_restr$scenario == "tabu_0.05_dvar"] <- benthicfish_masterdataset_sed_5km$new_grazinglevel*CD_scale
...
#facet_wrap(~graz)
ggsave(coralcover_grazinglevel_dvaronlyabr_w25_grazcol, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/coralcover_grazinglevel_dvaronlyabr_w25_grazcol_9.27.2022.png"), bg = "transparent", height = 10, width = 10)

ggplot(finalcov_restr[finalcov_restr$graz == 4,], aes(x = grazinglevel, y = coral_cover*100)) +
  geom_point(size=3, colour = "#2b83ba")+
  ylab("Coral Cover")+
  xlab("Grazing Level")#+
  #scale_color_manual(values=c("#d7191c","#fdae61","#abdda4","#2b83ba"),breaks=c(1,2,3,4), labels=c("Empirical Grazing Scenario", "Pessimistic Grazing Scenario", "Middling Grazing Scenario","Optimistic Grazing Scenario"))
#facet_wrap(~graz)
...
coralcover_mortalitylevel_dvaronlyabr_w25_grazcol <- ggplot(finalcov_restr, aes(x = mortalitylevel, y = coral_cover*100, color = as.factor(graz))) +
  ...
  theme(axis.text.x = element_text(size = 20), axis.text.y = element_text(size=20))
#facet_wrap(~graz)
ggsave(coralcover_mortalitylevel_dvaronlyabr_w25_grazcol, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/coralcover_mortalitylevel_dvaronlyabr_w25_grazcol_9.27.2022.png"), bg = "transparent", height = 10, width = 10)
...
coralcover_coralmovementlevel_dvaronlyabr_w25_grazcol <- ggplot(finalcov_restr, aes(x = coralmovementlevel, y = coral_cover*100, color = as.factor(graz))) +
  ...
  theme(axis.text.x = element_text(size = 20), axis.text.y = element_text(size=20))
#facet_wrap(~graz)
ggsave(coralcover_coralmovementlevel_dvaronlyabr_w25_grazcol, filename = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/plots_dvarmgmtonly/coralcover_coralmovementlevel_dvaronlyabr_w25_grazcol_9.27.2022.png"), bg = "transparent", height = 10, width = 10)
