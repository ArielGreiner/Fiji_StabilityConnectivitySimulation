...
finalavgcov <- data.frame(graz = seq(1,4,1), altsedten = NA, altsedtwentyfive = NA, tabu_qoliqoli_dvar = NA,  tabu_0.05_dvar = NA, altsed10_qoliqolitabu = NA, altsed25_qoliqolitabu = NA)
over30cov <- data.frame(graz = seq(1,4,1), altsedten = NA, altsedtwentyfive = NA, tabu_qoliqoli_dvar = NA,  tabu_0.05_dvar = NA, altsed10_qoliqolitabu = NA, altsed25_qoliqolitabu = NA)
for(j in 1:4){ #look across the 4 grazing rates, only looking at the dvar ones
  ...
  #25% alt sed
  altsed25_data <- readRDS(file = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/AltSed_NewTabu_7.2022/MixedScenario_Tabuoriginal_fullsimrun_allherbs_dval_25_alt_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_8.11.2022.rds"))
  ...
  #25% + qoli qoli 
  altsed25_qoliqoli_dvar_data <- readRDS(file = paste0("~/GitHub/PhDThesisProjects/Fiji_StabilityConnectivitySimulation/MgmtStressorScenarios/AltSed_NewTabu_7.2022/MixedScenario_Tabuqoliqoli_fullsimrun_allherbs_dval_25_alt_gammaval",gamma,"r_val",r,"_scalingfactor",j,"_8.11.2022.rds"))
...
mean(finalavgcov$altsedten) #0.262182
mean(finalavgcov$altsedtwentyfive) #0.2809339
mean(finalavgcov$tabu_qoliqoli_dvar) #0.2600327
mean(finalavgcov$tabu_0.05_dvar) #0.2701899
mean(finalavgcov$altsed10_qoliqolitabu) #0.2737683
mean(finalavgcov$altsed25_qoliqolitabu) #0.2948625
